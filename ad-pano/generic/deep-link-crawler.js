...
// ====
// Variables
var version = <CHANGE_THIS|2.005>;    // smallest version number to require
var country = <CHANGE_THIS|"us">;     // us or ca
var deepLinks = [];
var jsonUrls = [];
var entryUrl = KNWeb.GetURL(0);

var us = [<CHANGE_THIS|"ToyotaLGP_en-us_HOME",...>];
var ca = [<CHANGE_THIS|"CadillacATS_en-ca_Home",...>];
